...
//         //   let imagabase64 = '';
//         //   if (user.image) {
//         //     imagabase64 = new Buffer(user.image, 'base64').toString('binary');
//         //   }
...
class UserRedux extends Component {
  ...
  handleSaveUser = () => {
    ...
    console.log("check before submit state:", this.state);
  };
            ...
            <div className="row">
              ...
              <div className="col-3">
                ...
                <input
                  ...
                  value={numberPhone}
                  onChange={(event) => {
                    this.onChangeInput(event, "numberPhone");
                  }}
                ></input>
              </div>
              <div className="col-9">
